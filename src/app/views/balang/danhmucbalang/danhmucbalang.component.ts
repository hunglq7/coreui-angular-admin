...
@Component({
  ...
  templateUrl: './danhmucbalang.component.html',
  styleUrl: './danhmucbalang.component.scss',
})
export class DanhmucbalangComponent implements OnInit {
  private gridApi!: GridApi<BaLang>;
  data: BaLang[] = [];
  excelData: any;
  constructor(
  ...
  onGridReady(params: GridReadyEvent<BaLang>) {
  ...
  Delete() {
    ...
    this.dataService
      .post('/api/Danhmucbalang/DeleteMultipale', selectedRows)
      .subscribe({
        next: (data) => {
          this.loadData();
  ...
  save() {
    const selectedRows = this.gridApi.getSelectedRows();
    this.dataService
      .put('/api/Danhmucbalang/UpdateMultiple', selectedRows)
      .subscribe({
        next: (data) => {
          this.loadData();
          this.toastr.success(
  ...
  importexcel(event: any) {
    ...
    fileReader.onload = (e) => {
      ...
      this.dataService
        .put('/api/Danhmucbalang/UpdateMultiple', this.excelData)
        .subscribe({
          next: (data) => {
            this.loadData();
            this.toastr.success(

...
import { BangTai } from '../../../../app/core/interface/bangtai/bang-tai.interface';

ModuleRegistry.registerModules([AllCommunityModule, RowSelectionModule]);

@Component({
  selector: 'app-danhmucbangtai',
  imports: [
    RowComponent,
    ColComponent,
    TextColorDirective,
  ...
  templateUrl: './danhmucbangtai.component.html',
  styleUrl: './danhmucbangtai.component.scss',
})
export class DanhmucbangtaiComponent implements OnInit {
  private gridApi!: GridApi<BangTai>;
  data: BangTai[] = [];
  excelData: any;
  ...
  onGridReady(params: GridReadyEvent<BangTai>) {
  ...
  exportexcel() {
    ...
    XLSX.writeFile(wb, 'Danhmucbangtai.xlsx');
  }
  ...
  importexcel(event: any) {
    ...
    fileReader.onload = (e) => {
      ...
      this.dataService
        .put('/api/Danhmucbangtai/UpdateMultiple', this.excelData)
        .subscribe({
          next: (data) => {
            this.loadData();
            this.toastr.success(

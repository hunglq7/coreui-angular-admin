...
@Component({
  ...
  templateUrl: './danhmucchucvu.component.html',
  styleUrl: './danhmucchucvu.component.scss'
})
export class DanhmucchucvuComponent implements OnInit {
private gridApi!: GridApi<ChucVu>;
    data: ChucVu[] = [];
    constructor(
    ...
    ngOnInit(): void {
     ...
     rowSelection: RowSelectionOptions | 'single' | 'multiple' = {
          ...
          onGridReady(params: GridReadyEvent<ChucVu>) {
          ...
          loadData() {
            this.dataService.get('/api/Chucvu').subscribe({
              next: (response: any) => {
                this.data = response;
          ...
          save() {
            ...
            this.dataService
              .put('/api/Chucvu/UpdateMultiple', selectedRows)
              .subscribe({
                next: (data) => {
                  this.loadData();
                  this.toastr.success(
          ...
          confirmDelete() {
            ...
            dialogRef.afterClosed().subscribe((result) => {
              if (result) {
                const selectedRows = this.gridApi.getSelectedRows();
                this.dataService
                  .post('/api/Chucvu/DeleteMultipale', selectedRows)
                  .subscribe({
                    next: (data) => {
                      this.loadData();
                      this.toastr.success(

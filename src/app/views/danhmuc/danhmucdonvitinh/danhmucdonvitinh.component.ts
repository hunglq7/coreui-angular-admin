...
@Component({
  ...
  styleUrl: './danhmucdonvitinh.component.scss'
})
export class DanhmucdonvitinhComponent implements OnInit {

  private gridApi!: GridApi<DonViTinh>;
    data: DonViTinh[] = [];
    constructor(
  ...
  rowSelection: RowSelectionOptions | 'single' | 'multiple' = {
      ...
      onGridReady(params: GridReadyEvent<DonViTinh>) {
      ...
      save() {
        ...
        this.dataService
          .put('/api/Donvitinh/UpdateMultiple', selectedRows)
          .subscribe({
            next: (data) => {
              this.loadData();
              this.toastr.success(
      ...
      confirmDelete() {
        ...
        dialogRef.afterClosed().subscribe((result) => {
          if (result) {
            const selectedRows = this.gridApi.getSelectedRows();
            this.dataService
              .post('/api/Donvitinh/DeleteMultipale', selectedRows)
              .subscribe({
                next: (data) => {
                  this.loadData();
                  this.toastr.success(
